      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
          <div class="flex items-center h-10 intro-y">
            <h2 class="mr-5 text-lg font-medium truncate">Главная страница</h2>
            <a href="" class="flex items-center ml-auto text-primary">
              <Lucide icon="RefreshCcw" class="w-4 h-4 mr-3" /> Обновить
            </a>
          </div>
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              ...
              >
                <div class="p-5 box">
                  ...
                  <div class="mt-6 text-3xl font-medium leading-8">25</div>
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              ...
              >
                <div class="p-5 box">
                  ...
                  <div class="mt-6 text-3xl font-medium leading-8">7</div>
                  <div class="mt-1 text-base text-slate-500">Партнёров</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              ...
              >
                <div class="p-5 box">
                  ...
                  <div class="mt-6 text-3xl font-medium leading-8">34</div>
                  <div class="mt-1 text-base text-slate-500">Пользователя</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-span-12 mt-8 lg:col-span-6">
          <div class="items-center block h-10 intro-y sm:flex">
            <h2 class="mr-5 text-lg font-medium truncate">Отчёт продаж</h2>
            ...
            <div class="flex flex-col md:flex-row md:items-center">
              <div class="flex">
                <div>
                  ...
                  <div class="mt-0.5 text-slate-500">Этот мксяц</div>
                </div>
                <div
                ...
                <div>
                  ...
                  <div class="mt-0.5 text-slate-500">Прошлый месяц</div>
                </div>
              </div>
              <Menu class="mt-5 md:ml-auto md:mt-0">
                ...
                <Menu.Items class="w-40 h-32 overflow-y-auto">
                  <Menu.Item>B2C</Menu.Item>
                  <Menu.Item>B2B</Menu.Item>
                  <Menu.Item>Партнёры</Menu.Item>
                  <Menu.Item>Филиалы</Menu.Item>
                </Menu.Items>
              </Menu>
            </div>
            <div
        ...
        <div class="col-span-12 mt-8 sm:col-span-6 lg:col-span-3">
          <div class="flex items-center h-10 intro-y">
            <h2 class="mr-5 text-lg font-medium truncate">По типу заявок</h2>
            <a href="" class="ml-auto truncate text-primary"> больше </a>
          </div>
        ...
        <div class="col-span-12 mt-8 sm:col-span-6 lg:col-span-3">
          <div class="flex items-center h-10 intro-y">
            <h2 class="mr-5 text-lg font-medium truncate">По филиалам</h2>
            <a href="" class="ml-auto truncate text-primary"> больше </a>
          </div>
          <div class="p-5 mt-5 intro-y box">
            <div class="mt-3">
        ...
        <div class="grid grid-cols-12 2xl:pl-6 gap-x-6 2xl:gap-x-0 gap-y-6">
          ...
          >
            <div class="flex items-center h-10 intro-x">
              <h2 class="mr-5 text-lg font-medium truncate">Партнёры</h2>
            </div>
            <div class="mt-5">
              <div
